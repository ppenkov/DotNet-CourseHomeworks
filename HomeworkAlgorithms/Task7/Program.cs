...
namespace Task7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Quicksorting time in miliseconds: " + (Environment.TickCount - original));
            ...
            Console.WriteLine("Quicksorting time in miliseconds: " + (Environment.TickCount - even));
            ...
            Console.WriteLine("Quicksorting time in miliseconds: " + (Environment.TickCount - odd));
